document.addEventListener('DOMContentLoaded', function() {
    ...
    gif.src = 'https://cdn.jsdelivr.net/gh/HEATLabs/HEAT-Labs-Images@main/miscellaneous/tournament_confused_cat.gif';
    ...
    function preloadSound() {
        sound = new Audio('https://cdn.jsdelivr.net/gh/HEATLabs/HEAT-Labs-Database@main/sounds/tournament_confused_cat.wav');
        sound.load();
    }
    preloadSound();
