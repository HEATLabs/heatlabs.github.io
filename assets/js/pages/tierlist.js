document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadTanks() {
        const response = await fetch('https://raw.githubusercontent.com/HEATLabs/Website-Configs/refs/heads/main/tanks.json');
    ...
    async function loadMaps() {
        const response = await fetch('https://raw.githubusercontent.com/HEATLabs/Website-Configs/refs/heads/main/maps.json');
        const data = await response.json();
